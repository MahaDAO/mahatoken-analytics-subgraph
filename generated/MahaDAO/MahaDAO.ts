...
export class MahaDAO extends ethereum.SmartContract {
  static bind(address: Address): MahaDAO {
    return new MahaDAO("MahaDAO", address);
  }
  ...
  try_contactInformation(): ethereum.CallResult<string> {
    let result = super.tryCall(
      "contactInformation",
      "contactInformation():(string)",
      []
  ...
  link(): string {
    let result = super.call("link", "link():(string)", []);

    return result[0].toString();
  }

  try_link(): ethereum.CallResult<string> {
    let result = super.tryCall("link", "link():(string)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  reason(): string {
    let result = super.call("reason", "reason():(string)", []);

    return result[0].toString();
  }

  try_reason(): ethereum.CallResult<string> {
    let result = super.tryCall("reason", "reason():(string)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  website(): string {
    let result = super.call("website", "website():(string)", []);

    return result[0].toString();
  }

  try_website(): ethereum.CallResult<string> {
    let result = super.tryCall("website", "website():(string)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
